                ...
                for mandate in mandates:
                    ...
                    if mandate.data_type.value == DataTypes.GPS.value:
                        ...
                        executor.submit(mandate.consumption_routine, self.kafka_client, mandate.consumption_topic,
                                        self.tx_gps_data, LOGGER_Rx, lock)
                        # Platform Principal Axes Positioning should be enabled for GPS DataType only...
                        executor.submit(principal_axes_positioning, clock_callback, RealmTypes.RECEPTION,
...
class RxController(Controller):
    ...
    __serial_comm_config = SerialCommConfig(id='Bifrost_Rx', is_wireless=True, port='COM3',
