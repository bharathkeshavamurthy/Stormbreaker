...
boolean proceedToYaw = false, motorsInitiated = false, mandateAchieved = true;      // A flag to give the go-ahead to move on to yaw changes | A flag to indicate if the motors have been initiated or not | A flag to indicate that the overall correction mandate from the XXRealm Python Controller has been met
...
void loop() {
  ...
  */
  if ( (mandateAchieved == true) && (proceedToYaw == false) && (proceedToJunk == false) && (motorsInitiated == false) && ( (millis() - prevTime) > 100 ) ) {
    prevTime = millis();
  ...
  */
  ...
  if ( (mandateAchieved == true) && (tmpYaw != 720.0) && (tmpPitch != 720.0) && ( (tmpYaw != requiredYawAngle) || (tmpPitch != requiredPitchAngle) ) ) {
  ...
  if ( (mandateAchieved == false) && (proceedToYaw == false) && (proceedToJunk == false) && (sampleCounter >= READ_EQUILIBRIUM) ) {
  ...
  if ( (mandateAchieved == false) && (proceedToYaw == true) && (proceedToJunk == false) && (sampleCounter >= READ_EQUILIBRIUM) ) {
  ...
  if ( (mandateAchieved == false) && (proceedToYaw == false) && (proceedToJunk == true) && (sampleCounter >= READ_EQUILIBRIUM) ) {
    proceedToJunk = false;
