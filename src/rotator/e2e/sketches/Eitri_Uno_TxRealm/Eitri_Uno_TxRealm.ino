...
void loop() {
   ...
   *    
   *    TODO (v21.09): CHANGE DEFAULT VALUES HERE IN CASE THIS uC-BASED CONTROLLER DOES NOT HAVE A GPS MODULE
  */
  if ( (millis() - prevTime) > 100 ) {
    ...
    Serial.print(407661737);
    Serial.print(",");
    Serial.print(-18);
    Serial.print(",");
    Serial.print(40.766173670, 9);
    Serial.print(",");
    
    Serial.print(-111847940);
    Serial.print(",");
    Serial.print(18);
    Serial.print(",");
    Serial.print(-111.847939330, 9);
    Serial.print(",");
