...
const float pitchCoarseTestAngles[PITCH_ROTATION_STRATEGIES] = {10.0};                                   // Pitch angles to be tested (in degrees)

/* Rotation strategies: Fine-grained */
const float yawFineTestAngles[YAW_ROTATION_STRATEGIES] = {20.0};                                         // Yaw angles to be tested (in degrees)
