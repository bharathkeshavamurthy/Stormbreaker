...
//  Serial.print("Real: ");
//  Serial.println(myIMU.getQuatReal(FRS_RECORDID_ROTATION_VECTOR));
  Serial.print("Q1: ");
...
//  Serial.print("Quad accuracy: ");
//  Serial.println(myIMU.getQuatAccuracy());
//  Serial.print("Quad radian accuracy: ");
//  Serial.println(myIMU.getQuatRadianAccuracy());
  
  Serial.println();
  Serial.println("For magnetometer");
  Serial.print("Range: ");
  Serial.println(myIMU.getRange(FRS_RECORDID_MAGNETIC_FIELD_CALIBRATED), 4);
  Serial.print("Resolution: ");
  Serial.println(myIMU.getResolution(FRS_RECORDID_MAGNETIC_FIELD_CALIBRATED), 4);
  Serial.print("Q1: ");
  Serial.println(myIMU.getQ1(FRS_RECORDID_MAGNETIC_FIELD_CALIBRATED));
  Serial.print("Q2: ");
  Serial.println(myIMU.getQ2(FRS_RECORDID_MAGNETIC_FIELD_CALIBRATED));
  Serial.print("Q3: ");
  Serial.println(myIMU.getQ3(FRS_RECORDID_MAGNETIC_FIELD_CALIBRATED));
