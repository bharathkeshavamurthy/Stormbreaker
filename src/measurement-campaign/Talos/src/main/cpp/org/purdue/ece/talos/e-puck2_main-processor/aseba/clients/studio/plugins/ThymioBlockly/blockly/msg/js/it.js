...
Blockly.Msg.CONTROLS_FLOW_STATEMENTS_OPERATOR_CONTINUE = "prosegue con la successiva iterazione del ciclo";
...
Blockly.Msg.CONTROLS_REPEAT_TITLE = "per %1 volte";
...
Blockly.Msg.THYMIO_ACTUATOR_COMM = "imposta la comunicazione a Raggi Infrarossi a trasmettere";
Blockly.Msg.THYMIO_ACTUATOR_COMM_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_COMM_TOOLTIP = "Imposta la comunicazione a Raggi Infrarossi a inviare";
Blockly.Msg.THYMIO_ACTUATOR_MIC = "imposta la soglia del microfono a";
Blockly.Msg.THYMIO_ACTUATOR_MIC_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_MIC_TOOLTIP = "Imposta la soglia di sensibilità del microfono";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR = "imposta la velocità del motore %1 a %2";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR_LEFT = "sinistro";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR_RIGHT = "destro";
Blockly.Msg.THYMIO_ACTUATOR_MOTOR_TOOLTIP = "Imposta la velocità del motore del robot";
Blockly.Msg.THYMIO_ACTUATOR_SET_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_SET_TOOLTIP = "Imposta an actuator variable on the robot";
Blockly.Msg.THYMIO_ACTUATOR_TIMER = "imposta il %1 temporizzatore a %2 millisecondi";
Blockly.Msg.THYMIO_ACTUATOR_TIMER_FIRST = "primo";
Blockly.Msg.THYMIO_ACTUATOR_TIMER_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_ACTUATOR_TIMER_SECOND = "secondo";
Blockly.Msg.THYMIO_ACTUATOR_TIMER_TOOLTIP = "Imposta un timer del robot";
Blockly.Msg.THYMIO_ARITHMETIC_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_ARITHMETIC_TOOLTIP = "Calcola l'espressione aritmetica";
Blockly.Msg.THYMIO_BINARY = "%2 %1 %3";
Blockly.Msg.THYMIO_BINARY_AND = "and logico";
Blockly.Msg.THYMIO_BINARY_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_BINARY_LEFT_SHIFT = "scorrimento a sinistra";
Blockly.Msg.THYMIO_BINARY_OR = "or logico";
Blockly.Msg.THYMIO_BINARY_RIGHT_SHIFT = "scorrimento a destra";
Blockly.Msg.THYMIO_BINARY_TOOLTIP = "Esegui l'operazione binaria";
Blockly.Msg.THYMIO_BINARY_XOR = "xor logico";
Blockly.Msg.THYMIO_BUTTON_PRESSED = "il bottone %1 è premuto";
Blockly.Msg.THYMIO_BUTTON_PRESSED_BACKWARD = "indietro";
Blockly.Msg.THYMIO_BUTTON_PRESSED_CENTER = "centrale";
Blockly.Msg.THYMIO_BUTTON_PRESSED_FORWARD = "avanti";
Blockly.Msg.THYMIO_BUTTON_PRESSED_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_BUTTON_PRESSED_LEFT = "sinistra";
Blockly.Msg.THYMIO_BUTTON_PRESSED_RIGHT = "destra";
Blockly.Msg.THYMIO_BUTTON_PRESSED_TOOLTIP = "verifica se un bottone è premuto";
Blockly.Msg.THYMIO_COMMUNICATION = "%1 la comunicazione a Raggi Infrarossi";
Blockly.Msg.THYMIO_COMMUNICATION_DISABLE = "disabilita";
Blockly.Msg.THYMIO_COMMUNICATION_ENABLE = "abilita";
Blockly.Msg.THYMIO_COMMUNICATION_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_COMMUNICATION_TOOLTIP = "Controlla la funzionalità di comunicazione del robot";
Blockly.Msg.THYMIO_DECLARE_ARRAY = "dichiara %1 come vettore di dimensione %2";
Blockly.Msg.THYMIO_DECLARE_ARRAY_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_DECLARE_ARRAY_TOOLTIP = "Dichiara una vettore di una certa dimensione";
Blockly.Msg.THYMIO_EVENT_BUTTON = "quando il bottone %1 è %2";
Blockly.Msg.THYMIO_EVENT_BUTTON_BACKWARD = "indietro";
Blockly.Msg.THYMIO_EVENT_BUTTON_CENTER = "centrale";
Blockly.Msg.THYMIO_EVENT_BUTTON_FORWARD = "avanti";
Blockly.Msg.THYMIO_EVENT_BUTTON_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_BUTTON_LEFT = "a sinistra";
Blockly.Msg.THYMIO_EVENT_BUTTON_PRESS = "premuto";
Blockly.Msg.THYMIO_EVENT_BUTTON_RELEASE = "rilasciato";
Blockly.Msg.THYMIO_EVENT_BUTTON_RIGHT = "a destra";
Blockly.Msg.THYMIO_EVENT_BUTTON_TOOLTIP = "Reagire a un evento di bottone premuto o rilasciato";
Blockly.Msg.THYMIO_EVENT_PROX = "quando il sensore di prossimità %1 rileva %2";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_LEFT = "anteriore sinistro";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_LEFT_MIDDLE = "anteriore centrale sinistro";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_MIDDLE = "anteriore centrale";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_RIGHT = "anteriore destro";
Blockly.Msg.THYMIO_EVENT_PROX_FRONT_RIGHT_MIDDLE = "anteriore centrale destro";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND = "quando il sensore di prossimità inferiore %1 rileva %2";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_BLACK = "il colore nero";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_LEFT = "sinistro";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_NOPROX = "l'assenza del terreno";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_PROX = "la presenza del terreno";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_RIGHT = "destro";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_TOOLTIP = "Reagire a un evento di prossimità dal terreno";
Blockly.Msg.THYMIO_EVENT_PROX_GROUND_WHITE = "il colore bianco";
Blockly.Msg.THYMIO_EVENT_PROX_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_PROX_NOPROX = "l'assenza di un oggetto";
Blockly.Msg.THYMIO_EVENT_PROX_PROX = "la presenza di un oggetto";
Blockly.Msg.THYMIO_EVENT_PROX_REAR_LEFT = "posteriore sinistro";
Blockly.Msg.THYMIO_EVENT_PROX_REAR_RIGHT = "posteriore destro";
Blockly.Msg.THYMIO_EVENT_PROX_TOOLTIP = "Reagire a un evento di prossimità";
Blockly.Msg.THYMIO_EVENT_RECEIVE = "quando ricevi %1";
Blockly.Msg.THYMIO_EVENT_RECEIVE_COMM = "una comunicazione via Raggi Infrarossi";
Blockly.Msg.THYMIO_EVENT_RECEIVE_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_RECEIVE_RC = "un segnale di controllo remoto";
Blockly.Msg.THYMIO_EVENT_RECEIVE_TOOLTIP = "reagire a un evento di ricezione";
Blockly.Msg.THYMIO_EVENT_SHOCK = "quando rilevi un urto";
Blockly.Msg.THYMIO_EVENT_SHOCK_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_SHOCK_TOOLTIP = "Reagire a un evento di urto";
Blockly.Msg.THYMIO_EVENT_SOUND = "quando il suono %1";
Blockly.Msg.THYMIO_EVENT_SOUND_FINISHED = "ha finito l'esecuzione";
Blockly.Msg.THYMIO_EVENT_SOUND_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_SOUND_MIC = "supera la soglia";
Blockly.Msg.THYMIO_EVENT_SOUND_TOOLTIP = "Reagire a un evento sonoro";
Blockly.Msg.THYMIO_EVENT_TIMER = "quando il %1 temporizzatore ha terminato";
Blockly.Msg.THYMIO_EVENT_TIMER_FIRST = "primo";
Blockly.Msg.THYMIO_EVENT_TIMER_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_TIMER_SECOND = "secondo";
Blockly.Msg.THYMIO_EVENT_TIMER_TOOLTIP = "Reagire a un evento di temporizzatore terminato";
Blockly.Msg.THYMIO_EVENT_UPDATE = "quando %1 cambia";
Blockly.Msg.THYMIO_EVENT_UPDATE_ACC = "l'accellerometro";
Blockly.Msg.THYMIO_EVENT_UPDATE_BUTTONS = "lo stato dei bottoni";
Blockly.Msg.THYMIO_EVENT_UPDATE_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_EVENT_UPDATE_MOTOR = "il motore";
Blockly.Msg.THYMIO_EVENT_UPDATE_PROX = "un sensore di prossimità";
Blockly.Msg.THYMIO_EVENT_UPDATE_TEMPERATURE = "la temperatura";
Blockly.Msg.THYMIO_EVENT_UPDATE_TOOLTIP = "Reagire a un evento di cambiamento";
Blockly.Msg.THYMIO_FOR_DO = "esegui";
Blockly.Msg.THYMIO_FOR_FOR = "per";
Blockly.Msg.THYMIO_FOR_FROM = "da";
Blockly.Msg.THYMIO_FOR_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_FOR_TO = "a";
Blockly.Msg.THYMIO_FOR_TOOLTIP = "Incrementa una variabile da un valore iniziale a un valore finale";
Blockly.Msg.THYMIO_GET_ARRAY = "elemento %2 del vettore %1";
Blockly.Msg.THYMIO_GET_ARRAY_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_GET_ARRAY_TOOLTIP = "Leggi il valore di un elemento di un vettore";
Blockly.Msg.THYMIO_LED = "imposta il LED %1 a %2";
Blockly.Msg.THYMIO_LED_BOTTOM_LEFT = "inferiore sinistro";
Blockly.Msg.THYMIO_LED_BOTTOM_RIGHT = "inferiore destro";
Blockly.Msg.THYMIO_LED_BUTTON = "imposta i LED dei bottoni: avanti: %1 destra: %2 indietro: %3 sinistra: %4";
Blockly.Msg.THYMIO_LED_BUTTON_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_BUTTON_TOOLTIP = "Imposta la luminosità dei LED dei bottoni";
Blockly.Msg.THYMIO_LED_CIRCLE = "imposta i LED del cerchio: anteriore: %1 anteriore destro: %2 destro: %3 posteriore destro: %4 posteriore: %5 posteriore sinistro: %6 sinistro: %7 anteriore sinistro: %8";
Blockly.Msg.THYMIO_LED_CIRCLE_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_CIRCLE_TOOLTIP = "Imposta la luminosità dei LED del cerchio posto sulla faccia superiore del robot";
Blockly.Msg.THYMIO_LED_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_OFF = "spegni %1";
Blockly.Msg.THYMIO_LED_OFF_BOTTOM_LEFT = "il LED inferiore sinistro";
Blockly.Msg.THYMIO_LED_OFF_BOTTOM_RIGHT = "il LED inferiore destro";
Blockly.Msg.THYMIO_LED_OFF_BUTTONS = "i LED dei bottoni";
Blockly.Msg.THYMIO_LED_OFF_CIRCLE = "il cerchio di LED";
Blockly.Msg.THYMIO_LED_OFF_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_OFF_MICROPHONE = "il LED del microfono";
Blockly.Msg.THYMIO_LED_OFF_PROX_H = "i LED dei sensori di prossimità orizzontali";
Blockly.Msg.THYMIO_LED_OFF_PROX_V = "i LED dei sensori di prossimità inferiori";
Blockly.Msg.THYMIO_LED_OFF_RC = "il LED del controllo remoto";
Blockly.Msg.THYMIO_LED_OFF_TEMPERATURE = "i LED del sensore temperatura";
Blockly.Msg.THYMIO_LED_OFF_TOOLTIP = "Spegnere un LED";
Blockly.Msg.THYMIO_LED_OFF_TOP = "il LED superiore";
Blockly.Msg.THYMIO_LED_PROX = "imposta i LED dei sensori di prossimità orizzontali: sinistro: %1 anteriore sinistro centrale: %2 anteriore centrale sinistro: %3 anteriore centrale destro: %4 anteriore destro centrale: %5 anteriore destro: %6 posteriore sinistro: %7 posteriore destro: %8";
Blockly.Msg.THYMIO_LED_PROX_GROUND = "imposta i LED dei sensori di prossimità inferiori: sinistro: %1 destro: %2";
Blockly.Msg.THYMIO_LED_PROX_GROUND_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_PROX_GROUND_TOOLTIP = "Imposta la luminosità dei LED dei sensori di prossimità inferiori";
Blockly.Msg.THYMIO_LED_PROX_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_PROX_TOOLTIP = "Imposta la luminosità dei LED dei sensori di prossimità orizzontali";
Blockly.Msg.THYMIO_LED_RC_SOUND = "imposta il LED del %1 a %2";
Blockly.Msg.THYMIO_LED_RC_SOUND_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_RC_SOUND_RC = "controllo remoto";
Blockly.Msg.THYMIO_LED_RC_SOUND_SOUND = "microfono";
Blockly.Msg.THYMIO_LED_RC_SOUND_TOOLTIP = "Imposta la luminosità dei LED del controllo remoto e del microfono";
Blockly.Msg.THYMIO_LED_RGB = "imposta il LED %1 a rosso %2 verde %3 blu %4";
Blockly.Msg.THYMIO_LED_RGB_BOTTOM_LEFT = "inferiore sinistro";
Blockly.Msg.THYMIO_LED_RGB_BOTTOM_RIGHT = "inferiore destro";
Blockly.Msg.THYMIO_LED_RGB_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_RGB_TOOLTIP = "Imposta un LED a un colore specificando i valori RGB di Rosso, Verde e Blu";
Blockly.Msg.THYMIO_LED_RGB_TOP = "superiore";
Blockly.Msg.THYMIO_LED_TEMPERATURE = "imposta i LED del sensore di temperatura a rosso: %1 blu: %2";
Blockly.Msg.THYMIO_LED_TEMPERATURE_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_LED_TEMPERATURE_TOOLTIP = "Imposta la luminosità dei LED del sensore di temperatura";
Blockly.Msg.THYMIO_LED_TOOLTIP = "Imposta un LED a un colore specifico";
Blockly.Msg.THYMIO_LED_TOP = "superiore";
Blockly.Msg.THYMIO_MOTORS_START = "avvia i motori per %1 con velocità %2";
Blockly.Msg.THYMIO_MOTORS_START_BACKWARD = "andare indietro";
Blockly.Msg.THYMIO_MOTORS_START_FORWARD = "andare in avanti";
Blockly.Msg.THYMIO_MOTORS_START_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_MOTORS_START_SPINCCW = "ruotare in senso antiorario";
Blockly.Msg.THYMIO_MOTORS_START_SPINCW = "ruotare in senso orario";
Blockly.Msg.THYMIO_MOTORS_START_TOOLTIP = "Avvia i motori";
Blockly.Msg.THYMIO_MOTORS_START_TURNBACKWARDLEFT = "svoltare indietro a sinistra";
Blockly.Msg.THYMIO_MOTORS_START_TURNBACKWARDRIGHT = "svoltare indietro a destra";
Blockly.Msg.THYMIO_MOTORS_START_TURNLEFT = "svoltare a sinistra";
Blockly.Msg.THYMIO_MOTORS_START_TURNRIGHT = "svoltare a destra";
Blockly.Msg.THYMIO_MOTORS_STOP = "ferma i motori";
Blockly.Msg.THYMIO_MOTORS_STOP_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_MOTORS_STOP_TOOLTIP = "Ferma i motori";
Blockly.Msg.THYMIO_PROX_CHECK = "il sensore di prossimità %1 %2 ad un oggetto";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_LEFT = "anteriore sinistro";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_LEFT_MIDDLE = "anteriore centrale sinistro";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_MIDDLE = "anteriore centrale";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_RIGHT = "anteriore destro";
Blockly.Msg.THYMIO_PROX_CHECK_FRONT_RIGHT_MIDDLE = "anteriore centrale destro";
Blockly.Msg.THYMIO_PROX_CHECK_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_PROX_CHECK_NOPROX = "non è vicino";
Blockly.Msg.THYMIO_PROX_CHECK_PROX = "è vicino";
Blockly.Msg.THYMIO_PROX_CHECK_REAR_LEFT = "posteriore sinistro";
Blockly.Msg.THYMIO_PROX_CHECK_REAR_RIGHT = "posteriore destro";
Blockly.Msg.THYMIO_PROX_CHECK_TOOLTIP = "Verifica se il sensore di prossimità è vicino a un oggetto";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK = "il sensore di prossimità inferiore %1 ha rilevato %2";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_BLACK = "il colore nero";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_LEFT = "sinistro";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_NOPROX = "l'assenza del terreno";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_PROX = "la presenza del terreno";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_RIGHT = "destro";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_TOOLTIP = "Verifica se i sensori di prossimità inferiori";
Blockly.Msg.THYMIO_PROX_GROUND_CHECK_WHITE = "il colore bianco";
Blockly.Msg.THYMIO_SENSOR_ACC = "valore accellerometro %1";
Blockly.Msg.THYMIO_SENSOR_ACC_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_ACC_TOOLTIP = "Leggi il valore rilevato da un accellerometro";
Blockly.Msg.THYMIO_SENSOR_ACC_X = "x";
Blockly.Msg.THYMIO_SENSOR_ACC_Y = "y";
Blockly.Msg.THYMIO_SENSOR_ACC_Z = "z";
Blockly.Msg.THYMIO_SENSOR_COMM = "valore ricevuto dalla comunicazione via Raggi Infrarossi";
Blockly.Msg.THYMIO_SENSOR_COMM_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_COMM_TOOLTIP = "Legge il valore ricevuto dalla comunicazione via Raggi Infrarossi";
Blockly.Msg.THYMIO_SENSOR_MIC = "valore rilevato dal microfono";
Blockly.Msg.THYMIO_SENSOR_MIC_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_MIC_TOOLTIP = "Legge il valore di intensità sonora rilevato dal microfono";
Blockly.Msg.THYMIO_SENSOR_MOTOR = "velocità motore %1";
Blockly.Msg.THYMIO_SENSOR_MOTOR_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_MOTOR_LEFT = "sinistro";
Blockly.Msg.THYMIO_SENSOR_MOTOR_RIGHT = "destro";
Blockly.Msg.THYMIO_SENSOR_MOTOR_TOOLTIP = "Legge la velocità di un motore";
Blockly.Msg.THYMIO_SENSOR_PROX = "distanza dal sensore di prossimità %1";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_LEFT = "anteriore sinistro";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_LEFT_MIDDLE = "anteriore  sentrale sinistro";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_MIDDLE = "anteriore centrale";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_RIGHT = "anteriore destro";
Blockly.Msg.THYMIO_SENSOR_PROX_FRONT_RIGHT_MIDDLE = "anteriore centrale destro";
Blockly.Msg.THYMIO_SENSOR_PROX_GROUND_LEFT = "inferiore sinistro";
Blockly.Msg.THYMIO_SENSOR_PROX_GROUND_RIGHT = "inferiore destro";
Blockly.Msg.THYMIO_SENSOR_PROX_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_PROX_REAR_LEFT = "posteriore sinistro";
Blockly.Msg.THYMIO_SENSOR_PROX_REAR_RIGHT = "posteriore destro";
Blockly.Msg.THYMIO_SENSOR_PROX_TOOLTIP = "Legge la distanza dal sensore di prossimità";
Blockly.Msg.THYMIO_SENSOR_RC = "valore %1 recevuto dal controllo remoto";
Blockly.Msg.THYMIO_SENSOR_RC_ADDRESS = "dell'indirizzo";
Blockly.Msg.THYMIO_SENSOR_RC_COMMAND = "del comando";
Blockly.Msg.THYMIO_SENSOR_RC_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_RC_TOOLTIP = "Leggi il valore rilevato dal sensore di controllo remoto";
Blockly.Msg.THYMIO_SENSOR_TEMPERATURE = "valore rilevato dal sensore di temperatura";
Blockly.Msg.THYMIO_SENSOR_TEMPERATURE_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SENSOR_TEMPERATURE_TOOLTIP = "Leggi il valore rilevato dal sensore di temperatura";
Blockly.Msg.THYMIO_SET_ARRAY = "imposta il valore dell'elemento %2 del vettore %1 a %3";
Blockly.Msg.THYMIO_SET_ARRAY_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SET_ARRAY_TOOLTIP = "Imposta il valore di un elemento di un vettore";
Blockly.Msg.THYMIO_SOUND_NOTE = "esegui una nota da %1 Hz per %2 / 60 secondi";
Blockly.Msg.THYMIO_SOUND_NOTE_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SOUND_NOTE_TOOLTIP = "Esegue una nota di una certa frequenza espressa in Hertz per una certa durata espressa in sessantesimi di secondo";
Blockly.Msg.THYMIO_SOUND_STOP = "interrompi l'esecuzione del suono";
Blockly.Msg.THYMIO_SOUND_STOP_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SOUND_STOP_TOOLTIP = "Interrompe l'esecuzione del suono";
Blockly.Msg.THYMIO_SOUND_SYSTEM = "esegui il suono %1";
Blockly.Msg.THYMIO_SOUND_SYSTEM_ARROW = "dei bottoni a freccia";
Blockly.Msg.THYMIO_SOUND_SYSTEM_CENTRAL = "del bottone centrale";
Blockly.Msg.THYMIO_SOUND_SYSTEM_COLLISION = "di collisione";
Blockly.Msg.THYMIO_SOUND_SYSTEM_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SOUND_SYSTEM_SCARY = "di caduta libera (spaventoso)";
Blockly.Msg.THYMIO_SOUND_SYSTEM_SHUTDOWN = "di arresto";
Blockly.Msg.THYMIO_SOUND_SYSTEM_STARTUP = "di avvio";
Blockly.Msg.THYMIO_SOUND_SYSTEM_TARGET_DETECTED = "di obiettivo riconosciuto, per comportamento amichevole";
Blockly.Msg.THYMIO_SOUND_SYSTEM_TARGET_FRIENDLY = "di obiettivo ok, per comportamento amichevole";
Blockly.Msg.THYMIO_SOUND_SYSTEM_TOOLTIP = "Esegue un suono di sistema";
Blockly.Msg.THYMIO_SUBROUTINE_DEFINE_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_SUBROUTINE_DEFINE_SUBROUTINE = "sottoprogramma";
Blockly.Msg.THYMIO_SUBROUTINE_DEFINE_TOOLTIP = "Definire sottoprogrammi";
Blockly.Msg.THYMIO_UNARY_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_UNARY_TOOLTIP = "Applica un operatore unario";
Blockly.Msg.THYMIO_UNNARY = "%1 di %2";
Blockly.Msg.THYMIO_UNNARY_ABSOLUTE = "valore assoluto";
Blockly.Msg.THYMIO_UNNARY_BINARY_NOT = "complemento logico not";
Blockly.Msg.THYMIO_UNNARY_NEGATIVE = "negativo";
Blockly.Msg.THYMIO_VARIABLE_SET = "imposta la variabile %1 a %2";
Blockly.Msg.THYMIO_WHEN_DO = "esegui";
Blockly.Msg.THYMIO_WHEN_HELPURL = "https://www.thymio.org/it:thymiotutorielp2";
Blockly.Msg.THYMIO_WHEN_TOOLTIP = "Verifica il cambiamento di una condizione";
Blockly.Msg.THYMIO_WHEN_WHEN = "quando";
